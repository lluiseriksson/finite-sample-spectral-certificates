...
rational five-tap certificate with stopband norm at most $301/304$.  Numerical
...
constraints, target minors, commutators and Bernstein coefficients without a
numerical solver.
...
the tap conversion, are checked by the same exact-arithmetic replay.
