...
| Numerical evidence could be solver-dependent | Representative exact-rational dual replay exists | Exact/interval proof must cover the new headline constant or lemma | **Closed for both Route-C finite witnesses:** rational Bernstein replay for `301/304` and rational grid-plus-derivative replay for the measured `<24/25` certificate |
