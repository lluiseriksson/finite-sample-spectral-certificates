...
barrier for low-state routers, the resulting generic law, unbounded detector
gap, and complete four-line stratification.
...
degree-zero and degree-one approximation barriers;
...
obstruction is a computable lower bound, not a claim of sharpness for the full
degree--error tradeoff; determining $E_d$ exactly beyond the exhibited strata
remains open.
\end{limitation}
...
their physical/detector consequences; we do not claim a new
...
\begin{center}\small
\href{https://github.com/lluiseriksson/finite-sample-spectral-certificates/releases/tag/v3.1-planar-projective-memory}{GitHub release: \texttt{v3.1-planar-projective-memory}}
\end{center}
...
barrier.  The analysis also marks the next frontier precisely:
